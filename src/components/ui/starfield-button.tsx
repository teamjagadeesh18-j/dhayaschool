...
export function StarfieldButton(props: StarfieldButtonProps) {
    const {
        ...
        glow = { size: 16, color: "#ff8547", opacity: 100 },
        stroke = {
            size: 96,
            color: "#ff8547",
            count: 1,
        ...
        pixel = { size: 4, color: "#ff8547", density: 50, brightness: 100 },
        link = "",
    ...
    const fill = colors?.fill ?? fillProp ?? "#ff4f00"
    const textColor = colors?.textColor ?? textColorProp ?? "#FFFFFF"

    const {
        color: glowColor = "#ff8547",
        size: glowSize = 16,
